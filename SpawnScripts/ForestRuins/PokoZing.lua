...
function hailed(NPC, Spawn)
	...
	if HasQuest(Spawn, QUEST_FROM_GERMAIN) then
		...
		elseif GetQuestStep(Spawn, QUEST_FROM_GERMAIN) == 7 then
			...
			AddConversationOption(conversation, "PLACEHOLDER TEXT FOR RETURNING MATERIALS FOR FAVORS QUEST", "Step7Complete")
...
function Step7Complete(NPC, Spawn)
	...
	AddConversationOption(conversation, "PLACEHOLDER FOR RETURNING ITEMS")
